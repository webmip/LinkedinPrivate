...
<html lang="es">
  ...
  <body>
		...
		<div class="row">
			<div class="card m-b-0">
              <div class="card-block">
                <p>Cada día millones de personas introducen sus contraseñas en webs que sólo tratan de estafarles</p>
				<p>He creado este sitio web para ayudar a todas esas personas a entender la importancia de proteger su identidad en línea</p>
				<h5>IMPORTANTE:</h5><p> Esto es sólo un ejemplo, tu contraseña no ha sido leída, almacenada o procesada de ningún modo. Esta aplicación no tiene base de datos, por lo que tu contraseña no ha sido comprometida.</p>
              </div>
            </div>
		</div>
      </div>
	...
	<section class="section-pricing bg-faded text-xs-center">
      <div class="container">
        <h3>Por favor, ayúdame a concienciar a más gente</h3>
        <div class="row">
			<div class="card m-b-0">
              <div class="card-block">
                <p>Compártelo con tus contactos, esta web es multi-idioma</p>
				<p>Diles algo como: "Mira esta nueva herramienta para ver los contactos de LinkedIn de forma anónima"</p>
...
<div id="share-buttons">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active">
              <blockquote class="blockquote">
                <p class="h3">Esta web es completamente OpenSource, puedes ver su código en GitHub. Por favor, ayúdame a crear un Internet más seguro.</p>
	...
	<section class="section-pricing bg-faded text-xs-center">
      <div class="container">
        <h3>Dame tu opinión / Sugerencia</h3>
        <div class="row">
